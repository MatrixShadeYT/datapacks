...
execute if score tick entityclearing >= timer entityclearing run function entityclearing:ignore
#execute if score tick entityclearing >= timer entityclearing run function entityclearing:accept
