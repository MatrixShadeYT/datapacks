...
execute if score tick entityclearing >= timer entityclearing run kill @e[type=minecraft:experience_orb]
execute if score tick entityclearing >= timer entityclearing run kill @e[type=minecraft:item]
